-- =====================================================================
-- Section 4: Suspicious Fraud Patterns & Behavioral Profiling
-- =====================================================================
...
SELECT
    ...
    ROUND(SUM(reimbursed_amount), 2) AS total_same_day_payout
...
SELECT
    ...
    c.length_of_stay,
    c.reimbursed_amount,
    ROUND(c.reimbursed_amount / NULLIF(c.length_of_stay, 0), 2) AS reimbursement_per_day,
...
SELECT
    ...
    ROUND(CAST(COUNT(DISTINCT c.attending_physician) AS FLOAT) / COUNT(DISTINCT c.claim_id), 3) AS physician_to_claim_ratio
...
SELECT
    ...
    ROUND(SUM(reimbursed_amount), 2) AS total_amount,
